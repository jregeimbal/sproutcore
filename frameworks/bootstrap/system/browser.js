...
SC._detectBrowser = function(rawUserAgent, language) {
  ...
  var browser = {
    ...
    msie:         (/msie/.test(userAgent) && !/opera/.test(userAgent)) || (!!navigator.userAgent.match(/Trident.*rv\:11\./))  ? version : 0,
    mozilla:      /mozilla/.test( userAgent ) && !/(compatible|webkit)/.test(userAgent) && !navigator.userAgent.match(/Trident.*rv\:11\./) ? version : 0,
