...
module("SC.HorizontalListView.render", {
  ...
  setup: function() {
    ...
    view = SC.HorizontalListView.create({
      ...
      layout: { top: 0, left: 0, width: 500, height: 50 },
      
      layoutForContentIndex: function(idx) {
        return { top: 0, bottom: 0, left: idx * 50, width: 50 };
      },
      
      didReload: CoreTest.stub("didReload"),
      
      _cv_isVisibleInWindowDidChange: CoreTest.stub("_cv_isVisibleInWindowDidChange", function() {
        SC.HorizontalListView.prototype._cv_isVisibleInWindowDidChange.apply(this, arguments) ;
      }),
      
      _cv_nowShowingDidChange: CoreTest.stub("_cv_nowShowingDidChange", function() {
        SC.HorizontalListView.prototype._cv_nowShowingDidChange.apply(this, arguments) ;
      }),
...
//   console.trace(view.didReload.expect(1)); // currently popping twice
// });
