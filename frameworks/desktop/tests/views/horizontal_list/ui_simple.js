...
/*
  This test evaluates a plain list with no custom column heights, outlines, 
  group views or any other non-standard behavior.
*/

module("SC.HorizontalListView - simple list");
...
var pane = SC.ControlTestPane.design()
  .add("basic", SC.ScrollView.design({
    layout: { left: 0, height: 50, top: 0, width: 300 },
