...
config :all, 
  ...
  :test_required  => ['sproutcore/testing', 'sproutcore/empty_theme', 'sproutcore/standard_theme'],
...
config :statechart, :required => [:foundation], :test_required => [:foundation, :desktop]
